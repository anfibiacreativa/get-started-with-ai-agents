...
// The combination of allowed and usageName below is for AZD to check AI model gpt4o-mini quota only for the allowed regions for creating an agent.
...
@metadata({
  azd: {
    type: 'location'
    // quota-validation for ai models: gpt4o-mini
    usageName: [
